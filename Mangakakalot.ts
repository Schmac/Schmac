...
const SOURCE_DOMAIN = "mangakakalot.com"
...
export class Mangakakalot extends Source {
    ...
    get description(): string { return 'A source containing the popular website mangakakalot.com' }
    get author(): string { return 'Schmac' }
